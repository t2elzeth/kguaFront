...
export type SaveCardsProps = {};

const saveCardRows = [
  ["order_id", "integer", "да", "Номер (идентификатор) заказа в системе магазина, уникален для каждого магазина в пределах системы"],
  [
    "phone",
    "string",
    "да",
    ...
    >
      <div className="interface-rest">
        ...
        <CodeBox>
          ...
          <br />
          &nbsp;&nbsp;"fingerprint": "",
          <br />
          &#125;
        </CodeBox>
        <p>Пример ответа:</p>
