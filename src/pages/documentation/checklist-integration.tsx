...
export type ChecklistIntegrationProps = {};

const ChecklistIntegration: React.FC<ChecklistIntegrationProps> = () => {
  return (
    <DocumentationPage
      pageName="Чек-лист для интеграции"
      pageTitle="Чек-лист для интеграции"
    >
        <section>
          <h1>Чек-лист для интеграции</h1>
          <p>
            Контрольный список для создания интеграции онлайн-платежей с ioka.
          </p>
          <p>
            Следуйте приведенному ниже контрольному списку, чтобы убедиться, у
            вас есть полная реализация в ioka.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            Скопировать учетные данные API Получите доступ к своим учетным
            данным тестового API, чтобы начать выполнение тестовых транзакций.
          </p>
          <p>
            <span className="number-list">4</span>
            Запросить дополнительные тестовые способы оплаты Добавьте способы
            оплаты, которые вы хотите предложить своим покупателям. Для
            некоторых способов оплаты может потребоваться дополнительная работа
            по интеграции. Определите структуру тестового аккаунта ioka
            предоставляет двухуровневую структуру учетной записи, которая дает
            вам большую гибкость. Определите начальную структуру для
            тестирования, которая наилучшим образом представляет то, что вы
            будете делать после обработки в реальном времени. При запуске у вас
            будет еще одна возможность окончательно доработать структуру своего
            аккаунта.
          </p>
        </section>
        <section>
          ...
          <p>
            Задача вашей интеграции с ioka - это возможность совершать платежи и
            обрабатывать их последующие статусы.
          </p>
          <p>
            <span className="number-list">1</span>
        ...
        <section>
          ...
          <p>
            ioka полагается на наши веб-перехватчики уведомлений, чтобы
            информировать вашу систему о статусах платежей и других событиях,
            которые требуются в некоторых ситуациях, таких как знание результата
            вызова API возврата или получение результата оплаты некоторыми
            местными методами оплаты.
          </p>
          <p>
            <span className="number-list">1</span>
        ...
        <section>
          ...
          <p>
            Понимание и анализ наших отчетов имеет решающее значение для сверки.
          </p>
          <p>
            <span className="number-list">1</span>
        ...
        <section>
          ...
          <p>
            Чтобы начать принимать платежи от покупателей, вам необходимо
            Активировать ваш аккаунт ioka. После того, как вы получите учетные
            данные для своего Личного кабинета, следуйте нашему контрольному
            списку, чтобы начать принимать платежи.
          </p>
        </section>
    </DocumentationPage>
  );
