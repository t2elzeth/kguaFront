...
const rows = [
  ...
  [
    ...
    "string",
    "да",
    "Ссылка, служащая для перенаправления клиента на сайт",
  ],
  [
    "callback_url",
    "string",
    "нет",
    "Ссылка, служащая для приема статуса платежа после оплаты",
  ],
  [
    "template",
    "string",
...
const RefundPayment: React.FC<PaymentStatusProps> = () => {
  return (
    <DocumentationPage
      pageName="Статус платежа"
      pageTitle="Запрос состояния платежа"
    >
      <div className="interface-rest">
        ...
        <CodeBox>
          ...
          &nbsp;&nbsp;"error_code": 0,
          <br />
          &nbsp;&nbsp;"error_message": "Проведена полная авторизация суммы
          заказа",
          <br />
          &nbsp;&nbsp;"error_details": "",
          <br />
